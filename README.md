...
I am a D3 Informatics Engineering graduate from Universitas Dian Nuswantoro who genuinely loves learning. I picked up PHP, then Python for an NLP project, then Java for an Android app, then Next.js and TypeScript for a live production system — not because anyone told me to, but because each new tool made the next problem feel more interesting. That curiosity is what I bring to a team.

My work today spans three corners of software that I find hard to choose between: building inventory and e-commerce systems that real businesses depend on, designing REST APIs and database schemas that other developers can extend without cursing my name, and training NLP models on Indonesian text with proper statistical rigor. I have shipped production code, I have debugged things at 11pm, and I have read documentation top to bottom because the right answer was in there somewhere.

What I think separates me from the average D3 graduate: I am not just looking for a job that uses a specific framework. I am looking for a place where I can grow into an engineer the team relies on — and where the work matters enough to make that growth worth it.
...
## Why I Will Fit Your Team

- I learn new stacks by building with them. PHP first, then Python for ML, then Java for Android, then Next.js/TypeScript for live production — every tool on my GitHub came from a real project, not a tutorial.
- I communicate. I have presented my hate-speech research with proper statistical evaluation, I coordinated events inside the student body, and I wrote internship code that other developers had to read after me. Code is communication first.
- I document. Every public repo here has a README that explains what the project does, why it exists, and how to run it. The same instinct shows up in how I write commit messages and design REST endpoints.
- I care about the codebase I leave behind. A feature is not done when it works on my machine — it is done when the next developer can read it, extend it, and trust it.
